...
import com.cookandroid.team_project.ui.common.ScorersVMFactory
...
class ScorersFragment : Fragment() {
    ...
    private val viewModel: ScorersViewModel by viewModels {
        ScorersVMFactory(ServiceLocator.repository)
    }

    private val adapter = PlayerAdapter(statLabel = "득점")
